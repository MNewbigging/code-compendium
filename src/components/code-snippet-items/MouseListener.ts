...
const mouseListenerCode = `export type MouseEventCallback = () => void;
...
export const mouseListenerProps: CodeSnippetItemProps = {
  title: 'Mouse listener',
  description: 'Event listener for mouse events',
  code: mouseListenerCode,
};
