...
const canvasListenerCode = `export type ListenerCallback = () => void;
...
export const canvasListenerProps: CodeSnippetItemProps = {
  title: 'Canvas listener',
  description: 'Given canvas element, fires listener callbacks on resize',
  code: canvasListenerCode,
};
